...
\section{Sesión de problemas 1}
  ...
  %  * El título del problema se coloca como título de subsección.
  ...
  \subsection{Emma and sum of products}
  ...
  \subsection{Insertion Sort Advanced Analysis}
    \begin{enunciado}{Andrés Herrera}{Programación}
      Problema en Hackerrank:
