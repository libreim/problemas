...
\section*{Enunciado del Problema}
    El problema a resolver se encuentra en \href{https://www.hackerrank.com/contests/infinitum9/challenges/fibonacci-gcd}{Hackerrank}. Se muestra a continuación una versión traducida del mismo.
